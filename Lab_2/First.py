...
class Experiment:
    def __init__(self, X1_range: List[int], X2_range: List[int], Y_range: List[int], m: int) -> None:
        self.Rcritical = {5: 2, 6: 2.16, 7: 2.3, 8: 2.43, 9: 2.5}
    ...
    def check_results(self) -> None:
        ...
        print('\nПеревірка нормованих коефіцієнтів:     ', self.check_b)
